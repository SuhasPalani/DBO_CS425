...
alter table employee drop modified_at;
alter table employee drop created_at;
alter table customer modify email varchar(50);
alter table customer modify phone_number varchar(15);

insert into customer(cust_id,first_name,last_name,email,phone_number,address, user_name, password) values
...
Insert into Employee (emp_id, first_name,last_name,email, phone_number,user_name,password) values
...
INSERT INTO PARKING_LOT (lot_id, lot_name, location, total_Spots,available_spots, emp_id) values 
...
alter table parking_spot drop modified_at;

insert into parking_spot(spot_id,lot_id,spot_type,status) values
...
-- reservation, vehicle, parking_log, payment

desc reservation;

insert into reservation (res_id,cust_id,spot_id,expire_time,status) values
